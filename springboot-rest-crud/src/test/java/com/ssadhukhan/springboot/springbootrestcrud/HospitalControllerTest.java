package com.ssadhukhan.springboot.springbootrestcrud;
...
public class HospitalControllerTest {
	...
	public void retrievetest_ok() throws Exception {
		addhospital_ok();
		mockMvc.perform(get("/springboot-rest-crud/hospitals/1000")).andDo(print()).andExpect(status().isOk())
	...
	public void addhospital_ok() throws Exception {
		...
		mockMvc.perform(post("/springboot-rest-crud/hospitals/")// .andDo(print())
	...
	public void updatehospital_ok() throws Exception {
		...
		mockMvc.perform(get("/springboot-rest-crud/hospitals/1001")).andDo(print()).andExpect(status().isOk())
	...
	public void deleteHospital_ok() throws Exception {
		...
		hosp.setRating(3.8);
		byte[] hospJson = toJson(hosp);
		mockMvc.perform(delete("/springboot-rest-crud/hospitals/")// .andDo(print())
				.content(hospJson).contentType(MediaType.APPLICATION_JSON).accept(MediaType.APPLICATION_JSON))
